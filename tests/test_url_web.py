...
class ConvertTests(unittest.TestCase):
    ...
    def test_convert_video_path_other(self):
        urlother = url_web.convert_video_path('https://archive.org/serve/lhomme-de-la-rue/lhomme-de-la-rue-DP.ia.mp4')

        self.assertEqual(urlother, 'https://archive.org/serve/lhomme-de-la-rue/lhomme-de-la-rue-DP.ia.mp4')
