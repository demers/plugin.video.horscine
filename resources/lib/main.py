...
def root(plugin, content_type="video"):
    ...
    # List Categories
    resp = urlquick.get(url_constructor("/index.php"))
    root_elem = resp.parse("h2", attrs={"class": "elementor-heading-title elementor-size-default"})
